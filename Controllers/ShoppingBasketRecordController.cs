...
namespace CoolEStore.Controllers
{
    public class ShoppingBasketRecordController : Controller
    {
        ...
        {
            var appDbContext = _context.ShoppingBasketRecordModel.Include(s => s.Product).Include(s => s.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var shoppingBasketRecordModel = await _context.ShoppingBasketRecordModel
                .Include(s => s.Product)
                .Include(s => s.User)
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,UserId")] ShoppingBasketRecordModel shoppingBasketRecordModel)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.ProductModel, "Id", "Id", shoppingBasketRecordModel.ProductId);
            ViewData["UserId"] = new SelectList(_context.UserModel, "Id", "Id", shoppingBasketRecordModel.UserId);
            return View(shoppingBasketRecordModel);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var shoppingBasketRecordModel = await _context.ShoppingBasketRecordModel.FindAsync(id);
            if (shoppingBasketRecordModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (shoppingBasketRecordModel != null)
            {
                _context.ShoppingBasketRecordModel.Remove(shoppingBasketRecordModel);
            }
        ...
        {
            return _context.ShoppingBasketRecordModel.Any(e => e.Id == id);
        }
    }
}
